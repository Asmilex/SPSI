...
Una **identidad digital** es toda la información disponible online de un agente externo (como una persona, organización o dispositivo electrónico). La ISO/IEC 24760-1 define una identidad como *conjunto de atributos relacionados con una entidad*. Estos atributos pueden ser la fecha de nacimiento, el registro médico, detalles del banco, credenciales... Este término se extendió posteriormente para incluir aspectos de identificación personal.
